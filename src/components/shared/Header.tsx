...
function Header() {
  return (
    <header className="sticky top-0 dark:bg-[#030619] bg-[#ffffff] w-full flex flex-col md:flex-row justify-around outline-1 items-center h-32 py-3 md:h-20 max-w-[1500px] m-auto z-50">
